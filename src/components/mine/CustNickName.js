...
export default class CustNickName extends React.Component{
    ...
    onErrorClick  () {
        if (this.state.hasError) {
            Toast.info('Please enter your nickName', 2, null, false);
        }
    }
    onChange (value) {
    ...
    componentDidMount(){
        ...
        $.ajax({
            ...
            success: function(response, textStatus){
                ...
                if(response.code==1){
                    _this.setState({value:response.data.custNickName})
                }else{
    ...
    saveNickName(){
        ...
        $.ajax({
            ...
            data: {
               id:localStorage['id'],
               custNickName:_this.state.value,
            },
            dataType: 'json',
            beforeSend: function(XMLHttpRequest){
                //todo
