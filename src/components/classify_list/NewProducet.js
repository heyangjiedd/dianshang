...
export default class MoreGroup extends React.Component{
                ...
                <div className="ScrollContainer">
                    ...
                    <div className="ListOutsite"
                        ...
                        <ul className="ListInside classfiy-goods-list">
                            ...
                            <li className="all-world-img">
                                <div className="zhengping-baozheg">
                                    <h3 className="mui-text-center">全球尖货</h3>
                                    <h5 className="mui-text-center">渡渡自营，正品保障</h5>
                                </div>
                            </li>
                            {lis}
