...
import {Icon,Toast, Modal, Button, WhiteSpace, WingBlank } from 'antd-mobile';
		...
		return (
			<div className="lottery-pan">
			    <div className="rotate-con-pan">
					<div className={active ? "rotate-con-zhen rotate-con-zhen-rotate rotate"+angle : "rotate-con-zhen"}  onClick={
						(event) => {
						this.runLottery();
					}}>
					</div>
